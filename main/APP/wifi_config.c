...
/* 链接wifi名称 */
#define DEFAULT_SSID        "XiaomiWIFI"
/* wifi密码 */
#define DEFAULT_PWD         "060324sy"
/* 事件标志 */
...
void connet_display(uint8_t flag)
{
    if((flag & 0x80) == 0x80)
    {
        ...
        spilcd_show_string(0, 130, 200, 16, 16, "KEY0:Send data", MAGENTA);
    }
    ...
    {
        spilcd_show_string(0, 150, 200, 16, 16, (char*)network_connet.ip_buf, MAGENTA);
    }
